...
func (r *TaskRepository) FindByKey(_ context.Context, key string) (*domain.Task, error) {
...
func (r *TaskRepository) FindByProject(_ context.Context, project string) ([]*domain.Task, error) {
	// TODO: Implement task retrieval by project in Jira
	return nil, fmt.Errorf("not implemented")
}

// FindBySprint finds all tasks for a given sprint
func (r *TaskRepository) FindBySprint(_ context.Context, sprint string) ([]*domain.Task, error) {
	// TODO: Implement task retrieval by sprint in Jira
	return nil, fmt.Errorf("not implemented")
}

// FindByPlatform finds all tasks from a specific platform
func (r *TaskRepository) FindByPlatform(_ context.Context, platform string) ([]*domain.Task, error) {
...
func (r *TaskRepository) Delete(_ context.Context, key string) error {
	// TODO: Implement task deletion in Jira
	return fmt.Errorf("not implemented")
}

// DeleteByProjectAndSprint deletes all tasks for a given project and sprint
func (r *TaskRepository) DeleteByProjectAndSprint(_ context.Context, project, sprint string) error {
